    ...
    var watchInternal = React.useCallback(function (fieldNames, defaultValue, watchId) {
        ...
        if (isString(fieldNames)) {
            ...
            if (fieldArrayNamesRef.current.has(parentNodeName)) {
                fieldValues = __assign(__assign({}, fieldArrayValuesRef.current), fieldValues);
            }
...
var useFieldArray = function (_a) {
    ...
    var getDefaultValues = function (values) {
        return get(shouldUnregister ? values : shallowFieldsStateRef.current, name, []);
    };
...
function useForm(_a) {
    ...
    var validateResolver = React.useCallback(function (values) {
        if (values === void 0) { values = {}; }
        return __awaiter(_this, void 0, void 0, function () {
            var newDefaultValues, errors, isValid;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        newDefaultValues = isEmptyObject(fieldsRef.current)
                            ? defaultValuesRef.current
                            : {};
                        return [4 /*yield*/, resolverRef.current(__assign(__assign(__assign({}, newDefaultValues), getValues()), values), contextRef.current, isValidateAllFieldCriteria)];
                    case 1:
                        errors = ((_a.sent()) || {}).errors;
                        isValid = isEmptyObject(errors);
                        formStateRef.current.isValid !== isValid &&
