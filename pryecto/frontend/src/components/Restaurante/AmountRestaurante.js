...
const AmountRestaurante = (restaurante) => {
    ...
    return (
        <div className="container">
            ...
            <div className="row mt-5 justify-content-xl-between d-flex justify-content-sm-center">
                <div className="d-flex register-user col-sm-12" style={{ width: "40%" }}>
                    <div className="m-2 col justify-content-left">
                        <p className="mt-2">Nombre: {restaurante.restaurante.name}</p>
                    ...
                    <div className="m-2 col-5 justify-content-xl-left mt-5 ml-4">
